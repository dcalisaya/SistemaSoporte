...
using SistemaSoporte.Blazor.Server.Services;
using DevExpress.Persistent.BaseImpl.PermissionPolicy;

namespace SistemaSoporte.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<SistemaSoporteBlazorApplication>(Configuration);
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(SistemaSoporte.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // Comment out the following line if using PermissionPolicyUser or a custom user type.
                options.UserLoginInfoType = typeof(SistemaSoporte.Module.BusinessObjects.ApplicationUserLoginInfo);
