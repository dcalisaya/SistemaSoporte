...
namespace SistemaSoporte.Blazor.Server {
    public partial class SistemaSoporteBlazorApplication : BlazorApplication {
        public SistemaSoporteBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void SistemaSoporteBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
